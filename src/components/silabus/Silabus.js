...
const Syllabus = () => {
  const meetings = [
    ...
    },
    {
      ...
      description: 'הסרת ג׳ל בצורה נכונה ומדויקת, מניקור מכשירי, מבנה אנטומי עם רבר בייס, השלמת סדקים בפול ג׳ל או השלמת ציפורן בטיפס ג׳ל.'
    }
  ];
  ...
  return (
    <>
      <div className={styles.syllabusWrapper} id="קורס לק גל">
        <div className={styles.container}>
          ...
          <div className={styles.description}>
            ...
            חיזוק המבנה הציפורניים בעזרת בסיס ולק ג׳ל בשילוב עם
      ...
      <Button text="גרטה, אני רוצה לשמוע עוד" message="היי גרטה,אשמח לשמוע עוד לגבי קורס ל'ק גל למתחילות" />
    </>
  );
};
